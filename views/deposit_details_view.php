...
<div class="container">
    <h1 align="center" class="title" style="font-size: 20pt; padding-bottom: 5px">Ajout détails pour l'accompte
        référencé ci-dessous </h1>
    <div class="page"
         style="padding: 0 15px; background-color: rgba(161,175,204,0.6); border-radius: 0 10px 10px 10px;">
        <form action="" method="post">
            ...
            <div class="row">
                ...
                <div align="center" class="col-md-4 mb-3">
                    <label for="Customernumber">Référence accompte
                        :<?php if (isset($_SESSION['depositnumber'])) echo " ", $_SESSION['depositnumber']; ?></label>
                </div>
                <div align="center" class="col-md-4 mb-3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <button name="btndeposit_detail_Insert" type="submit" class="btn btn-success btn-yellow"
                            value="insert"
            ...
            <tr>
                ...
                <td align="center">
                    <a class="btn btn-info btn-sm"
                       href='index.php?page=deposit_details&idDetailQuote=<?php echo $donnee['idQd']; ?>&designation=<?php echo $donnee['designation'] ?>
...
<div class="container">
    <h2 align="center">Les détails d'accompte
        :<?php if (isset($_SESSION['depositnumber'])) echo " ", $_SESSION['depositnumber']; ?> </h2>
    <table class="table table-striped table-bordered">
        <tr class='bg-color'>
            <th scope='col'>Ident</th>
            <th scope='col'>Désignation</th>
        ...
        <!----------- Boucle affichage l'ajout de details pour l'accompte ------------>
        <?php
        // Instance of quote_details class
        $depositdetail = new Deposit_details();
        $depositListe = $depositdetail->getAlldeposit_Details($_SESSION['idD']);
        // Loop display all quotedetails
        while ($donnee = $depositListe->fetch()) {
            ?>
            <tr>
                <td>  <?php echo $donnee['idDd']; ?>       </td>
                <td>  <?php echo $donnee['designation']; ?></td>
                <td>  <?php echo $donnee['unit']; ?>       </td>
                <td>  <?php echo $donnee['amount']; ?>     </td>
                <td>  <?php echo $donnee['totaluwt']; ?>  </td>
                ...
                <td align="center">
                    <a class="btn btn-danger btn-sm"
                       href='index.php?page=deposit_details&idDeletedetaildeposit=<?php echo $donnee['idDd']; ?>'>
